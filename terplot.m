...
% Make x-tick labels
for i=1:number
    htick(i,1)=text(l(i),-0.025,num2str(1-l(i)),'fontsize',16);
    htick(i,3)=text(1-l(i)*cos(pi/3)+0.025,l(i)*sin(pi/3)+0.025,num2str(1-l(i)),'fontsize',16);
    htick(i,2)=text(0.5-l(i)*cos(pi/3)-0.06,sin(pi/3)*(1-l(i)),num2str(1-l(i)),'fontsize',16);
end
